                        ...
                        <div className='md:w-1/2 md:ml-10'>
                                ...
                                <div className='flex gap-2 mt-2'>
                                    {selectedProduct.sizes.map((size) => (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded border ${selectedSize === size ? 'bg-black text-white' : 'bg-white text-black'}`}>{size}</button>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className='mb-6'>
                                ...
                                <div className='flex items-center space-x-4 mt-2'>
                                    <button onClick={() => handleQuantityChange(-1)} className='px-2 py-1 bg-gray-200 rounded text-lg cursor-pointer'>
                                        -
                                    </button>
